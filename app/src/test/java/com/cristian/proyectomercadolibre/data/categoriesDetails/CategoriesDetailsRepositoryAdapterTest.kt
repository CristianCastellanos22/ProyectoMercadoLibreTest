...
class CategoriesDetailsRepositoryAdapterTest : TestCase() {

    @Mock
    private lateinit var categoriesDetailsApiSource: CategoriesDetailsApiSource
    ...
    fun `testGetCategoriesDetails`() {
        runBlocking {
            ...
            Mockito.`when`(categoriesDetailsApiSource.getCategoriesDetails(details)).thenReturn(returnResponse)
            val result = categoriesDetailsRepositoryAdapter.getCategoriesDetails(details)
